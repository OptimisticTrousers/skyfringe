const PrivacyPolicy = () => {
  return (
    <div style={{padding: "2rem", marginTop: "2rem"}}>
      ...
      <p>
        At Skyfringe, accessible from https://skyfringe.netlify.app/login, one
        of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by Skyfringe and how we use it.
      </p>
      ...
      <p>
        Skyfringe follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, Skyfringe uses "cookies". These cookies are used
      ...
      <p>
        ...
        advertising partners of Skyfringe.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Skyfringe, which are sent
      ...
      <p>
        Note that Skyfringe has no access to or control over these cookies that
      ...
      <p>
        Skyfringe's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Skyfringe does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in Skyfringe. This policy is not applicable to any
