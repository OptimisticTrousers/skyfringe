...
// Use the middleware
app.get("/posts/:postId", validatePostId_1.default);
describe("validatePostId middleware function", () => {
    it("throws an error if the post ID is not valid", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app).get(`/posts/invalid-postid`);
    ...
    it("throws an error if the post is not found", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app).get("/posts/609e39ca255e1d2cd452e2d8" // non-existing ObjectId
        );
        expect(response.headers["content-type"]).toMatch(/json/);
